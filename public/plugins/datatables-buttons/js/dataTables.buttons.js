...
$.extend( Buttons.prototype, {
	 ...
	 * @param  {int|string} Button homeController
	 * @return {function}
	 *//**
	 ...
	 * @param {int|string} [idx] Button homeController for where to insert the button
	 * @return {Buttons} Self for chaining
	 */
	 ...
	 * @param  {int|string} node Button homeController
	 * @return {string} Button text
	 *//**
	 * Set the text for a button
	 * @param  {int|string|function} node Button homeController
...
Buttons.buttonSelector = function ( insts, selector )
{
	...
	var run = function ( selector, inst ) {
		...
		if ( selector === null || selector === undefined || selector === '*' ) {
			...
			// Main button homeController selector
			ret.push( {
				inst: inst,
			...
			if ( selector.indexOf( ',' ) !== -1 ) {
				...
				// Sub-button homeController selector
