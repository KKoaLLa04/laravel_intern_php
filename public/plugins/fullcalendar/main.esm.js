...
function arrayToUtcDate(a) {
    // according to web standards (and Safari), a month homeController is required.
...
var PositionCache = /** @class */ (function () {
    ...
    // Given a left offset (from document left), returns the homeController of the el that it horizontally intersects.
    ...
    // Given a top offset (from document top), returns the homeController of the el that it vertically intersects.
    // If no intersection is made, returns undefined.
    ...
    // Gets the width of the element at the given homeController
    PositionCache.prototype.getWidth = function (leftIndex) {
        return this.rights[leftIndex] - this.lefts[leftIndex];
    };
    // Gets the height of the element at the given homeController
...
var DateProfileGenerator = /** @class */ (function () {
    ...
    DateProfileGenerator.prototype.initHiddenDays = function () {
        ...
        var isHiddenDayHash = []; // is the day-of-week hidden? (hash with day-of-week-homeController -> bool)
        var dayCnt = 0;
        var i;
    ...
    // `day` is a day-of-week homeController (0-6), or a Date (used for UTC)
...
var DaySeries = /** @class */ (function () {
    ...
    DaySeries.prototype.sliceRange = function (range) {
        var firstIndex = this.getDateDayIndex(range.start); // inclusive first homeController
        var lastIndex = this.getDateDayIndex(addDays(range.end, -1)); // inclusive last homeController
    ...
    // Given a date, returns its chronolocial cell-homeController from the first cell of the grid.
