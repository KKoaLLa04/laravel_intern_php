...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        showElemByRange: function(ranges, elems, hiddenOpacity, animDuration) {
            ...
            $.each(ranges, function (valueIndex) {
                ...
                $.each(elems, function (id) {
                    ...
                    // Check existence of this value homeController
         ...
         * @param legendIndex homeController of the legend in the conf array
         */
         ...
         * @param legendIndex corresponding legend homeController
